...
from torch.nn import AvgPool2d, Flatten, Linear, ReLU, CrossEntropyLoss, Softmax, Conv2d
...
class QuantumDropout(tq.QuantumModule):
    ...
    def forward(self, x):
        ...
        for i in range(self.batch_size):
            mask[i, topk[i]] = 0.0
        x = x * mask  # Cannot use *= as this operates in-place, which causes errors for torch.autograd
